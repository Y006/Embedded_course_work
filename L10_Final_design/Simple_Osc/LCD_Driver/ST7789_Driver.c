...
// 定义 ST7789 的 MADCTL 寄存器的位设置
#define MADCTL_MY  0x80  // 行地址顺序
#define MADCTL_MX  0x40  // 列地址顺序
#define MADCTL_MV  0x20  // 行列交换
#define MADCTL_ML  0x10  // 垂直刷新顺序
#define MADCTL_RGB 0x08  // RGB 顺序

// 定义屏幕方向
#define SCREEN_VERTICAL_1   (MADCTL_MX | MADCTL_RGB)
#define SCREEN_HORIZONTAL_1 (MADCTL_MV | MADCTL_MX | MADCTL_RGB)
#define SCREEN_VERTICAL_2   (MADCTL_MY | MADCTL_RGB)
#define SCREEN_HORIZONTAL_2 (MADCTL_MV | MADCTL_MY | MADCTL_RGB)
...
void ST7789_Set_Rotation(uint8_t Rotation)
{
    ...
    switch (Rotation)
    {
        case SCREEN_VERTICAL_1:
            ST7789_Write_Data(SCREEN_VERTICAL_1);
            LCD_WIDTH = ST7789_SCREEN_HEIGHT; 
            LCD_HEIGHT = ST7789_SCREEN_WIDTH;
            break;
        case SCREEN_HORIZONTAL_1:
            ST7789_Write_Data(SCREEN_HORIZONTAL_1);
            LCD_WIDTH = ST7789_SCREEN_WIDTH; 
            LCD_HEIGHT = ST7789_SCREEN_HEIGHT;
            break;
        case SCREEN_VERTICAL_2:
            ST7789_Write_Data(SCREEN_VERTICAL_2);
            LCD_WIDTH = ST7789_SCREEN_HEIGHT; 
            LCD_HEIGHT = ST7789_SCREEN_WIDTH;
            break;
        case SCREEN_HORIZONTAL_2:
            ST7789_Write_Data(SCREEN_HORIZONTAL_2);
            LCD_WIDTH = ST7789_SCREEN_WIDTH; 
            LCD_HEIGHT = ST7789_SCREEN_HEIGHT;
            break;
        default:
...
//	ST7789_Set_Rotation(SCREEN_VERTICAL_1);						// 设置显示方向
